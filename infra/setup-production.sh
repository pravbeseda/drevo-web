...
cat > infra/inventory/production.cfg << EOF
...
echo -e "${GREEN}Configuration saved to infra/inventory/production.cfg${NC}"

# Add to .gitignore if not already there
if ! grep -q "infra/inventory/production.cfg" .gitignore; then
    echo "infra/inventory/production.cfg" >> .gitignore
