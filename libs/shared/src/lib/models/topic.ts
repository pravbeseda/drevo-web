...
export const TOPICS: readonly Topic[] = [
    ...
    { id: 4, name: 'Термины, понятия', icon: 'topic_help' },
    ...
    { id: 9, name: 'Памятные события, праздники', icon: 'topic_event' },
    { id: 10, name: 'Церковнославянский', icon: 'topic_cslav' },
    { id: 11, name: 'Документы', icon: 'topic_document' },
    { id: 13, name: 'Тексты с комментариями', icon: 'topic_bookmark' },
    { id: 14, name: 'Календарь', icon: 'topic_event' },
    { id: 15, name: 'Хронология', icon: 'topic_event' },
    { id: 16, name: 'Служебные статьи', icon: 'topic_document' },
];
